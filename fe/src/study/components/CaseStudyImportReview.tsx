...
import { Alert, Button, Form, Input, Select, Tabs, message } from "antd";
...
export function CaseStudyImportReview({ preview, saving, onCancel, onSave }: Props) {
  ...
  const handleSave = async () => {
    ...
    await onSave({ title, description, status, passages, questions, warnings: preview.warnings });
  };
